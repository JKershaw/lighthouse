...
| --- | --- | --- |
| Establish | Weeks 1 and 2 | Assign owners, access and budgets; open study records; register instruments and sources; confirm Harbour's current record fields and retention |
| Calibrate | Weeks 3 and 4 | Run LH001; export Harbour records; reconcile readings with known events; document overhead and gaps |
