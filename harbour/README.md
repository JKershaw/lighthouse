...
What a subagent spent is read from its transcript, not from the launcher, whose token figure is the subagent's final context size. Cache reads dominate, and every subagent writes about 45,000 tokens of harness context before it starts. notes/Q-0002-model-choices.md has the measurements.
