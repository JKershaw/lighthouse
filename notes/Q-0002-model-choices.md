...
2026-09-26, later. Superseded in part by D-0002 in registers/decisions.md on the keeper's steer: Opus 5.5 takes the tasks that need reasoning. The table's Sonnet 5 defaults stand for collection scripts, source checks and tabulation.
