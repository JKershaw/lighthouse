...
- Commit as Claude (`-c user.name=Claude -c user.email=noreply@anthropic.com`) with the trailers the harness gives. Work on the branch the session names and fast-forward main when asked.
