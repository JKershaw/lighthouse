...
Draft | 25 September 2026 | LH F02
...
Harbour's dispatch and proxy integration documentation describes the dispatch item fields, lifecycle states, feedback markers, usage entries, audit logging and retention windows referred to in LH F03 and LH F04. Read from the main branch on 25 September 2026; verify against the running version before a study relies on a field.
...
Harbour's writing standard for papers and essays defines the header fields and the Answer, Findings, Method, Limits and Next structure that Lighthouse studies adopt in LH F03.
